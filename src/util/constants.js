...
export const LISTS_URL = import.meta.env.LISTS_URL;
export const LEDGE_URL = `${import.meta.env.LISTS_URL}/ledge`;
export const USERMETA_URL = `${import.meta.env.LISTS_URL}/meta/users`;
